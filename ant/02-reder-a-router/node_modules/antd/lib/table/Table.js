...
var Table = function (_React$Component) {
    ...
    function Table(props) {
        ...
        _this.renderSelectionRadio = function (_, record, index) {
        ...
        _this.renderSelectionCheckBox = function (_, record, index) {
            var rowIndex = _this.getRecordKey(record, index); // 从 1 开始
            var checked = void 0;
            if (_this.state.selectionDirty) {
                checked = _this.state.selectedRowKeys.indexOf(rowIndex) >= 0;
    ...
    Table.prototype.renderColumnsDropdown = function renderColumnsDropdown(columns) {
        ...
        return (0, _util.treeMap)(columns, function (originColumn, i) {
            ...
            if (column.filters && column.filters.length > 0 || column.filterDropdown) {
                ...
                filterDropdown = _react2["default"].createElement(_filterDropdown2["default"], { locale: locale, column: column, selectedKeys: colFilters, confirmFilter: _this9.handleFilter, prefixCls: prefixCls + '-filter', dropdownPrefixCls: dropdownPrefixCls || 'ant-dropdown' });
            }
            if (column.sorter) {
