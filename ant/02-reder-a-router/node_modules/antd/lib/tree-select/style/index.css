...
.ant-select-tree-checkbox-wrapper:hover .ant-select-tree-checkbox-checked .ant-select-tree-checkbox-inner,
.ant-select-tree-checkbox-wrapper:hover .ant-select-tree-checkbox-indeterminate .ant-select-tree-checkbox-inner,
